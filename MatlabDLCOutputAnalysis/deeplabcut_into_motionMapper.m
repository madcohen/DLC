function deeplabcut_into_motionMapper()
...
filePath = 'C:\PCOM_ThesisMaterials\Emory DLC\EmorySideNetV4-mad-2021-07-26\videos';
TaskName ='Walking';
deeplabcutfile = 'Basler_acA1920-150um__40004490__20210723_153356843DLC_resnet50_EmorySideNetV4Jul26shuffle1_50000.csv';

%input header information:
[LF, RF, LH, RH, TB] = import(deeplabcutfile,4,1000);
fileName = strcat(TaskName,'_',deeplabcutfile);

% Compute Projections Matrix: (put in your body parts list!)
AllBodyparts = horzcat(LF, RF, LH, RH, TB);
% align to a set bodypart, here "bp1":
%AllBodypartsMinusOne = horzcat(LF-RF-LH-RH-TB);
...
parameters.embedding_batchSize = 1; 
